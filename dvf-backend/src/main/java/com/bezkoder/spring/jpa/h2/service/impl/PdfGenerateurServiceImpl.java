...
@Service
public class PdfGenerateurServiceImpl implements PdfGenerateurService {

    private final Logger logger = Logger.getLogger(PdfGenerateurServiceImpl.class.getName());
    ...
    public PdfGenerateurServiceImpl(TransactionRepository transactionRepository, MinioClientService minioClientService, MyWebSocketHandler myWebSocketHandler) {
